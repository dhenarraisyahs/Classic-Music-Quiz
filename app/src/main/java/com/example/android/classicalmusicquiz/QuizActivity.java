...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    private void notifPlayback(PlaybackStateCompat stateCompat) {
    ...
    private void initializePlayer(Uri mediaUri) {
        ...
        String user = Util.getUserAgent(this, "Quiz Musik Klasik");
        MediaSource mediaSource = new ExtractorMediaSource(mediaUri, new DefaultDataSourceFactory(this, user), new DefaultExtractorsFactory(), null, null);
        composerView.setPlayer(exoPlayer);
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        if ((playbackState == ExoPlayer.STATE_READY) && playWhenReady) {
            ...
            mplaybackState.setState(PlaybackStateCompat.STATE_PLAYING, exoPlayer.getCurrentPosition(), 1f);
        ...
        mediaSession.setPlaybackState(mplaybackState.build());
        notifPlayback(mplaybackState.build());
    }
